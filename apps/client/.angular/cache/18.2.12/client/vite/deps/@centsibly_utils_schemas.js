...
var MAX_NUMBER_VALUE = 999999999999;

// ../../packages/utils/dist/schemas/schemas.js
var ExpenseSchema = z.object({
  name: z.string(),
  amount: z.number().int().min(1).max(MAX_NUMBER_VALUE)
});
var CurrencySchema = z.enum(["USD", "EUR", "JPY", "GBP", "CAD", "CNY", "KRW", "SGD", "HKD", "NZD", "INR", "MXN", "RUB", "ZAR"]);
var BudgetInfoSchema = z.object({
...
//# sourceMappingURL=@centsibly_utils_schemas.js.map
